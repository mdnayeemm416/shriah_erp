  ...
  Future<void> _launchMapsUrl(String shopLocation) async {
    try {
      ...
      if (shopLocation.contains('|')) {
        coords = shopLocation.split('|')[0].replaceAll('° N', '').replaceAll('° E', '').replaceAll('Lat:', '').replaceAll('Lon:', '').replaceAll(' ', '');
      } else {
        coords = shopLocation.replaceAll('° N', '').replaceAll('° E', '').replaceAll('Lat:', '').replaceAll('Lon:', '').replaceAll(' ', '');
      }
