...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BhUBSjxB.mjs");
...
const manifest = {
  "0312b81896911627caa331f27642b01c3f60a445abbeb99db77fdae44a25331e": {
    functionName: "deleteManagedUser_createServerFn_handler",
    importer: () => import("./user-management.functions-M3hXuPQg.mjs")
  },
  "199a1dfcb832cba4276a57d1ba65c2798db766ee68beae045fa1b236e6966fa0": {
    functionName: "resetManagedUserPassword_createServerFn_handler",
    importer: () => import("./user-management.functions-M3hXuPQg.mjs")
  },
  "282ae33f2214e7d600b0a9d05c75806270daae4f0abd9f90ed522de1a789efc4": {
    functionName: "erpPasswordLogin_createServerFn_handler",
    importer: () => import("./login.functions-COSTNku6.mjs")
  },
  "2923c6bfe4ee4a4c42cf27179544627629a97b4ba688a5ff8cd5a8b16649468d": {
    functionName: "listManagedUsers_createServerFn_handler",
    importer: () => import("./user-management.functions-M3hXuPQg.mjs")
  },
  "2958977d1401a1ac12eb5a49626ed0d94a4fc6d8582d53453f58ad7fdfd7c4e6": {
    functionName: "searchProductImages_createServerFn_handler",
    importer: () => import("./find-product-image.functions-D36wkrrt.mjs")
  },
  "2fd0bae907d3c91f1c0045e38e90ad09f93d21194d789b1746088d1a2cb34488": {
    functionName: "saveRemoteProductImage_createServerFn_handler",
    importer: () => import("./find-product-image.functions-D36wkrrt.mjs")
  },
  "466f52ae3ae5a562e460e6a1e5660a6e9322a7d2bbcb8dfca482364d895e2736": {
    functionName: "updateManagedUser_createServerFn_handler",
    importer: () => import("./user-management.functions-M3hXuPQg.mjs")
  },
  "635847dbd120c7c098b3b27b6da65c9e9f3387591c623e37d97e33e1dc692cad": {
    functionName: "scanSlip_createServerFn_handler",
    importer: () => import("./slip-scan.functions-DlogS0d1.mjs")
  },
  "8289e6ec78b8c6cef7637f9b05c922be18560a6cdc25bafe41446ed4625056ba": {
    functionName: "listUserPageAccess_createServerFn_handler",
    importer: () => import("./user-management.functions-M3hXuPQg.mjs")
  },
  "86f2b33668784a5fa4206e065b7ed1d5b206632742a97de1a331f366e77fec51": {
    functionName: "createManagedUser_createServerFn_handler",
    importer: () => import("./user-management.functions-M3hXuPQg.mjs")
  },
  "aacf05a2cebdac8139b2c754498bdb45d285ad701b945d231d6b86e421b9d6d2": {
    functionName: "softDeleteRecord_createServerFn_handler",
    importer: () => import("./soft-delete.functions-qSNUubF8.mjs")
  },
  "acd09be1e16500c343548e01ee8271391acdb54c80c99aefefb211c4a49e831d": {
    functionName: "updateUserPageAccess_createServerFn_handler",
    importer: () => import("./user-management.functions-M3hXuPQg.mjs")
  },
  "ada96da53a57089459bc3c0ca2412497b43a7f81cf001cdc531af5057a36d9d2": {
    functionName: "setAttachmentRequired_createServerFn_handler",
    importer: () => import("./user-management.functions-M3hXuPQg.mjs")
  },
  "e27b523ea095daa7d1e0d0e90d742cdfcc609072796482d7ca2bb2c7e29cf0ff": {
    functionName: "scanDocument_createServerFn_handler",
    importer: () => import("./ai-scan.functions-CHVxcjOI.mjs")
  },
  "f5f10a45a6775ac9aadc54a74c16557eca5da5a0a515c56b09d0b0b2cf6648eb": {
    functionName: "setManagedUserDisabled_createServerFn_handler",
    importer: () => import("./user-management.functions-M3hXuPQg.mjs")
  },
  "f6008fb268cb9e2c65b3f529deb104377b2748eb3b3858ba195d74268a921e4f": {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-KeVl8_Ln.mjs").then((n) => n.b3),
    import("./start-Be5OixH_.mjs"),
