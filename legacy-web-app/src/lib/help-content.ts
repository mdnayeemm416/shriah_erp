// Central knowledge base for the in-app Info / Help / How-To-Use system.
// Every metric, formula, and page explanation lives here so it can be
// referenced from anywhere via a small ⓘ Info button or the /help page.

export type MetricInfo = {
  title: string;
  what: string;                 // What this value means
  formula?: string;             // How it is calculated
  inputs?: string[];            // Which entries affect it
  example?: string;             // Plain-English example
};
...
export const METRIC_INFO: Record<string, MetricInfo> = {
  cash_in_hand: {
    ...
    formula:
      "Opening Cash + Shop Cash Sales + Warehouse Cash Sales + Bank Withdraw − Purchases − Expenses − Cash Out",
    inputs: [
    ...
    example:
      "If opening cash is 1,000 and you record 500 cash sale and 100 expense, Cash in Hand = 1,400.",
  },
  bank_balance: {
    title: "Bank Balance",
    ...
    example:
      "Opening 2,000 + 500 bank sale − 300 withdraw = 2,200 Bank Balance.",
  },
  warehouse_value: {
    title: "Warehouse Value",
    what:
      "Approximate financial value of stock & receivables held in the warehouse.",
    formula:
      "Opening Stock + Due Receivable + New Stock Purchases − Warehouse Sales",
    inputs: [
  ...
  plus_minus: {
    title: "Plus / Minus",
    what:
      "Daily reconciliation difference between what POS reported and what was actually collected.",
    formula: "(Cash Sale + Bank Sale + Credit Sale) − POS Sale",
    example:
      "Positive = collected more than POS (over). Negative = short (under).",
  },
  purchase: {
    title: "Purchase",
  ...
  expense: {
    title: "Expense",
    what:
      "Day-to-day shop spending — salaries, utilities, repairs, supplies, etc.",
  },
  withdraw: {
    title: "Bank Withdraw",
  ...
  employee_due: {
    ...
    what:
      "Net amount owed by (or to) an employee. Positive = employee owes you, negative = advance held.",
  ...
  filter_custom: {
    title: "Custom Date",
    what:
      "Pick any From and To dates — both are inclusive. Useful for arbitrary periods.",
  },
};

// How-To-Use guide sections, rendered on the /help route.
export type HowToSection = {
  id: string;
  title: string;
  purpose: string;          // What this page does
  inputs: string[];         // Which entries / settings affect it
  workflow: string[];       // How the workflow works (ordered steps)
  bestPractice: string;     // Best usage method
};

export const HOW_TO: HowToSection[] = [
  {
    id: "dashboard",
    title: "Dashboard",
    purpose:
      "Live snapshot of money across cash, bank and warehouse — refreshed every time you save an entry.",
    inputs: [
    ...
    bestPractice:
      "Use Dashboard for high-level reading only. Make actual entries from Shop, Warehouse or Transactions.",
  },
  {
    id: "shop",
    title: "Shop Page",
    purpose:
      "Daily operational ledger — record POS readings, cash, bank, credit, purchases, expenses and withdraws per shop.",
    inputs: [
    ...
    bestPractice:
      "Close each shop day-by-day. The Plus/Minus column tells you if cash matches POS.",
  },
  {
    id: "transactions",
    title: "Transactions",
    purpose:
      "Manual money movements that are not tied to a shop — bank, cash-out, supervisor payments, adjustments.",
    ...
    bestPractice:
      "Always use Transactions for adjustments rather than editing opening balances.",
  },
  {
    id: "warehouse",
    title: "Warehouse",
    purpose:
      "Track inventory value, new stock purchases, wholesale receivables and warehouse-direct sales.",
    ...
    bestPractice:
      "Reconcile Due Receivable monthly — collections should drop it back near zero.",
  },
  {
    id: "employees",
    title: "Employees",
    purpose:
      "Track money given to and received from each employee. Generates a printable / WhatsApp-ready statement.",
    ...
    bestPractice:
      "Settle balances regularly. A positive balance means the employee still owes you.",
  },
  {
    id: "reports",
    title: "Reports",
    ...
    bestPractice:
      "Use Monthly for management reviews and Custom Date for audits.",
  },
  {
    id: "ocr",
    title: "OCR Import",
    purpose:
      "Scan paper receipts / Z-reports — the system extracts totals and line items automatically.",
    ...
    bestPractice:
      "Always sanity-check totals before saving; OCR is a helper, not a replacement.",
  },
  {
    id: "backup",
    title: "Backup & Export",
    purpose:
      "Download spreadsheets and PDFs for offline backup, accounting or sharing.",
...
// Keys that should appear in the dedicated "Calculation Logic" section.
